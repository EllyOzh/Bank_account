...
def filter_by_state(info_client: List[Dict[str, Union[str, int]]], state: str = 'EXECUTED') -> List[Dict[str, Union[str, int]]]:
...
def sort_by_date(info_client: List[Dict[str, Union[str, int]]], ascending: bool = 'True') -> List[Dict[str, Union[str, int]]]:
